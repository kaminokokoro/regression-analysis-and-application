...
install.packages("dataset") # cài đặt gói lệnh
library(datasets)
attach(mtcars)
...
t.test(two$residuals) # kiem dinh xem gia tri trung binh cua phan du co bang 0 khong khi biet phan du tuan theo phan phoi chuan
